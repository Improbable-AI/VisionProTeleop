...
// MARK: - Dropbox Recording Thumbnail View

struct DropboxRecordingThumbnailView: View {
    let recording: DropboxRecordingInfo
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                ...
                HStack(spacing: 4) {
                    ...
                    // Size
                    if let size = recording.videoSize {
    ...
    private func loadThumbnail() async {
        ...
        thumbnail = await RecordingsManager.shared.getDropboxThumbnail(for: recording)
    }
}

// MARK: - Dropbox Recording Detail View

struct DropboxRecordingDetailView: View {
    let recording: DropboxRecordingInfo
    ...
    private let dropboxColor = Color(red: 0, green: 0.4, blue: 1)
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 16) {
                ...
                if recording.hasTracking || playbackController.totalFrames > 0 {
                    skeletonSection
                }
        ...
        GroupBox {
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(spacing: 8) {
                    ...
                    InfoRow(label: "Path", value: recording.path)
                    ...
                    if let size = recording.videoSize {
                        InfoRow(label: "Video Size", value: ByteCountFormatter.string(fromByteCount: size, countStyle: .file))
                    }
...
#Preview {
    NavigationStack {
        DropboxRecordingDetailView(recording: DropboxRecordingInfo(
            id: "test",
            name: "recording_20241125_143000",
            path: "/Apps/VisionProTeleop/recording_20241125_143000",
            hasVideo: true,
            hasMetadata: true,
            hasTracking: true,
